...
def phi4(x1,x2,x3,x4):
    return And(3*x1 + 2*x2 - 3*x3 + 4*x4 < 120, 3*x1 - 5*x4 > 12, 2*x1 - x3 + 2*x4 < 234, x3 + x4 - x1 + 2*x2 > 1024, 2*x1 - 4*x4 < 134)

def phi5(x1,x2,x3,x4,x5):
    return And(4*x1 + 5*x2 - 3*x3 - 4*x4 +10*x5 < 3062, 14*x1 - 8*x2 + 4*x3 + 2*x5 > 13,   2*x2 - 4*x3 - x4 - 6*x5 > 3)
...
def construct_EFA():
    ...
    T31.extend([g3000, Or(g3100,g3001,g3010),Or(g3011,g3101,g3110),g3111])

    g40 = Exists(x1, And(Not(theta(x1)), domain1(x1), phi41(x1)))
    g41 = And(theta(x1), domain1(x1), phi41(x1))
    T41.append(g40)
    T41.append(g41)
    ...
    #T11 --> T61: 7-->12    T12-->T62:  13--->18   T71-->T72: 19 20    T7:21
...
src = {"q0": [1, 2, 19, 20, 21], "q1": [3], "q3": [4], "q2": [5], "q4": [6],
       "q01": [7, 8], "q11": [9], "q31": [10], "q21": [11], "q41": [12],
       "q02": [13, 14], "q12": [15], "q32": [16], "q22": [17], "q42": [18]}
des = { 1: "q1", 2: "q3", 3: "q2", 4: "q4", 5: "q2", 6: "q4",
        7: "q11", 8: "q31", 9: "q21", 10: "q41", 11: "q21", 12: "q41",
        13: "q12", 14: "q32", 15: "q22", 16: "q42", 17: "q22", 18: "q42",
        19: "q01", 20: "q02", 21:"q0"
       }