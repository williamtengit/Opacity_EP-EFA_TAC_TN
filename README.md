...
Note: When the total execution time exceeds 300 seconds, we consider the program Timed Out, and the sys.maxsize is the large integer 9223372036854775807 in Python.
